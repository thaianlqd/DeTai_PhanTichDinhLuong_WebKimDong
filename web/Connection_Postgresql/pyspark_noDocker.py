...
def connect_to_mongodb():
    ...
    db = mongo_client['books_data_KimDong_210']  # Thay tên database MongoDB của bạn
...
def create_spark_session():
    spark = SparkSession.builder \
        ...
        .config("spark.mongodb.input.uri", "mongodb://localhost:27017/books_data_KimDong_150.books_KimDong") \
...
def load_data_from_mongodb(spark):
    ...
    spark.conf.set("spark.mongodb.input.uri", "mongodb://localhost:27017/books_data_KimDong_204.books_KimDong")
